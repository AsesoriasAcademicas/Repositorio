<%-- 
    Document   : VerClasePresencial
    Created on : 12/03/2018, 10:44:13 AM
    Author     : Alex
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function personalizarElementos() {
                ...
                if ('<%= session.getAttribute("confirmacionExitosaVerClasePresencial")%>' == "") {
                ...
                } else if ('<%= session.getAttribute("confirmacionFallidaVerClasePresencial")%>' == "") {
    ...
    <body onload="personalizarElementos()">
        ...
        <section id="contenido">
            ...
            <article>
                <p id="confirmacionExitosaVerClasePresencial" class="confirmacionExitosa"></p>
                <p id="confirmacionFallidaVerClasePresencial" class="confirmacionFallida"></p>
                ...
                <section class="datoformulario">
                    <table id="datos">
                        ...
                        <tr>
                            <td>
                                <p id="hora" class="contformulario"><b>Hora:</b> <%if (cls != null) {%> <%= cls.getHoraClase()%> <%}%></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p id="duracion" class="contformulario"><b>Duración(Horas):</b> <%if (cls != null) {%> <%= cls.getDuracionClase()%> <%}%></p>
                            </td>
                        </tr>
                    </table>
                </section>
                ...
                <section>
                    <table id="datos">
                        ...
                        <tr>
                            <td>
                                <p id="materia" class="contformulario"><b>Materia:</b> <%if (cls != null) {%> <%= cls.getTutoria().getAsignaturaTutoria()%> <%}%></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p id="tema" class="contformulario"><b>Tema:</b> <%if (cls != null) {%> <%= cls.getTutoria().getTemaTutoria()%> <%}%></p>
                            </td>
                        </tr>    
                        <tr>
                            <td>
                                <p id="mensaje" class="contformulario"><b>Dudas/Inquietudes:</b> <%if (cls != null) {%> <%= cls.getTutoria().getDudasInquietudesTutoria()%> <%}%></p>
                            </td>
                        </tr>
                    </table>
                </section>
                <section class="confirmarformulario">
                    ...
                    <a href="EditarClasePresencial.jsp?CodigoTutoria=<%= cls.getTutoria().getCodigoTutoria()%>"> <button type="button" id="btnAtras">Editar Clase</button></a>                    
                </section>
            </article>
        </section>
