<%-- 
    Document   : EliminarTrabajo
    Created on : 15/03/2018, 12:15:10 AM
    Author     : Alex
--%>
...
<%
    ...
    for (i = 0; i < workList.size(); i++) {
            ...
            if (tls.getTutoria().getCodigoTutoria() == Integer.parseInt(request.getParameter("CodigoTutoria"))) {
                i = workList.size();
                sesion.setAttribute("codigo", tls.getTutoria().getCodigoTutoria());
            }
    }
%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function personalizarElementos() {
                ...
                if ('<%= session.getAttribute("confirmacionFallidaEliminarTrabajo")%>' != "" && '<%= session.getAttribute("confirmacionExitosaEliminarTrabajo")%>' == "") {
                    document.getElementById("confirmacionFallidaEliminarTrabajo").innerHTML = '<%= session.getAttribute("confirmacionFallidaEliminarTrabajo")%>';
                    document.getElementById("confirmacionFallidaEliminarTrabajo").style.display = "block";
                    document.getElementById("confirmacionExitosaEliminarTrabajo").style.display = "none";
                } else if ('<%= session.getAttribute("confirmacionFallidaEliminarTrabajo")%>' == "" && '<%= session.getAttribute("confirmacionExitosaEliminarTrabajo")%>' != "") {
                    document.getElementById("confirmacionExitosaEliminarTrabajo").innerHTML = '<%= session.getAttribute("confirmacionExitosaEliminarTrabajo")%>';
                    document.getElementById("confirmacionExitosaEliminarTrabajo").style.display = "block";
                    document.getElementById("confirmacionFallidaEliminarTrabajo").style.display = "none";
                }
            }
    ...
    <body onload="personalizarElementos()">
        ...
        <section id="contenido">
            ...
            <article>
                <p id="confirmacionExitosaEliminarTrabajo" class="confirmacionExitosa"></p>
                <p id="confirmacionFallidaEliminarTrabajo" class="confirmacionFallida"></p>
                ...
                <section class="confirmarformulario">
                    ...
                    <a href="borrarTrabajo"><button type="button" id="btnEliminarCalse" onclick="return confirm('¿Esta seguro(a) de eliminar el Trabajo seleccionado?');">Eliminar Trabajo</button></a>
                </section>
            </article>
        </section>
